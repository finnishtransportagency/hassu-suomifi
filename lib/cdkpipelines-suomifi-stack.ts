  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const rdsinstance = new rds.DatabaseCluster(this, "db", {
      ...
      credentials: rds.Credentials.fromPassword(
        "postgres",
        SecretValue.ssmSecure("/dev/keycloak/postgresPassword", "1")
      ),
      instanceProps: {
        // TODO: oletusarvoisesti halvin kehitys ja testikayttoon sopiva burstable t3 class. Tuotantoa varten suunniteltava kapasiteetti.
